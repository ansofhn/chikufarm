                    ...
                    <div className="fixed top-0 z-20 w-1/2 p-6 ease-out delay-150 bg-white -left-96 -h-96 lg:top-4 lg:bottom-4 lg:left-4 lg:w-60 lg:rounded-xl peer-focus:left-0 peer:transition">
                        <div className="flex flex-col items-center justify-start">
                            ...
                            <div className="w-full pb-4 my-4 border-gray-100">
                                <Link href={"/dashboard"}>
                                    <div className="flex items-center justify-start gap-4 p-2 px-2 mb-2 transition duration-200 rounded-md cursor-pointer focus:bg-cream hover:bg-cream group">
                            ...
                            {/* logout Section */}
                            <div className="w-full pb-4 border-gray-100 my-96">
                                <Button
                                    onClick={handleLogout}
                                    className="flex items-center justify-start w-full gap-4 px-2 py-5 mb-2 transition duration-200 border rounded-md cursor-pointer border-shadowColor hover:border-cream hover:bg-cream group"
                                >
                    ...
                    <div className="fixed top-0 z-20 w-1/2 p-6 ease-out delay-150 bg-white -left-96 -h-96 lg:top-4 lg:bottom-4 lg:left-4 lg:w-60 lg:rounded-xl peer-focus:left-0 peer:transition">
                        <div className="flex flex-col items-center justify-start">
                            ...
                            <div className="w-full pb-4 my-4 border-gray-100">
                                ...
                                >
                                    <div>
                                        <Menu.Button className="flex items-center justify-start gap-4 p-2 px-2 mb-2 transition duration-200 rounded-md cursor-pointer focus:bg-cream hover:bg-cream group ">
                            ...
                            {/* logout Section */}
                            <div className="w-full pb-4 border-gray-100 my-28">
                                <Button
                                    onClick={handleLogout}
